                ...
                <table className="w-full border-collapse">
                  <thead>
                    <tr className="bg-gray-100">
                      <th className="text-left p-3 border-b">Vendor Name</th>
                      <th className="text-left p-3 border-b">Bank Account No.</th>
                      <th className="text-left p-3 border-b">Bank Name</th>
                  ...
                  <div className="flex items-center space-x-1">
                    {Array.from({ length: pagination.totalPages }, (_, i) => i + 1).map((page) => (
                      <Button
                        ...
                        className={`w-10 h-10 ${pagination.page === page 
